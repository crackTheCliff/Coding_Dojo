...
def show_recipe(id):
    ...
    return render_template("show_recipe.html",recipe=Recipe.get_one(data),user=User.get_by_id(user_data),owner=Recipe.one_with_recipes(data))
